    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="出入类型" prop="churujiluTypes">
                        <el-select v-model="ruleForm.churujiluTypes" :disabled="ro.churujiluTypes" placeholder="请选择出入类型">
                            <el-option
                    ...
                    <div v-else>
                        <el-form-item class="input" label="出入类型" prop="churujiluValue">
